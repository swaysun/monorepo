<template>
  <div class="demo-item">
    ...
    <div
      class="demo-block"
      :class="[blockClass, { 'demo-block_hover': hovering }]"
    >
      <!-- 组件模块预览 -->
...
export default {
  ...
  watch: {
    isExpanded(val) {
      this.codeViewEle.style.height = val
        ? `${this.codeViewHeight + 1}px`
        : '0';
  ...
  methods: {
    scrollHandler() {
      ...
      console.log(
        this.$refs.codeRefs.getBoundingClientRect(),
